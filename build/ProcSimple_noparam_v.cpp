...
#include "obj_dir_ProcSimple_noparam/VProcSimple_noparam.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_ProcSimple_noparam/VProcSimple_noparam__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VProcSimple_noparam_t;

  // Exposed methods
  VProcSimple_noparam_t * create_model( const char * );
  void destroy_model( VProcSimple_noparam_t *);
  void comb_eval( VProcSimple_noparam_t * );
  void seq_eval( VProcSimple_noparam_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VProcSimple_noparam_t *, char * );
  #endif
...
VProcSimple_noparam_t * create_model( const char *vcd_filename ) {

  VProcSimple_noparam_t * m;
  VProcSimple_noparam   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VProcSimple_noparam_t *) malloc( sizeof(VProcSimple_noparam_t) );
  model = new VProcSimple_noparam();
...
void destroy_model( VProcSimple_noparam_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VProcSimple_noparam * model = (VProcSimple_noparam *) m->model;
...
void comb_eval( VProcSimple_noparam_t * m ) {
...
void seq_eval( VProcSimple_noparam_t * m ) {
...
#if VLINETRACE
void trace( VProcSimple_noparam_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_ProcSimple_noparam__v );
